...
# O erro numérico ao usar float32 é muito menor do que:
...
# Ou seja: não muda a imagem.
    ...
    # print(f"time_zero => {time_zero.dtype}")
    fdemod = 0
    ...
    time_zero += 10 / fc
    # print( 3   f"time_zero OFFSET => {time_zero}")
